...
# --- ВЕРСІЯ 5.4.1 (Tactical UI + Map Switcher) ---
...
# Словник доступних базових карт
MAP_PROVIDERS = {
...
# --- 4. ІНТЕРФЕЙС (UI) ---
st.set_page_config(page_title="НХР V.5.4.1 Tactical", layout="wide", initial_sidebar_state="collapsed")
...
with col_inputs:
    ...
    with tabs[2]:
        # НОВИЙ ЕЛЕМЕНТ: Вибір типу базової карти
