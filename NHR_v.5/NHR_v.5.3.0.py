...
with col_map:
    ...
    <div style="position: absolute; top: 180px; right: 15px; z-index: 9999; background-color: rgba(30, 30, 30, 0.65); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); padding: 15px; border-radius: 10px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.5); font-family: Arial, sans-serif; color: #fff; min-width: 180px;">
