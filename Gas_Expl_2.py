...
st.info("""**Сценарій:** На території резервуарного парку складу стиснених газів відбулася розгерметизація резервуару із подальшим вибухом газу. Кількість речовини та її вид наведено в таблицях 1, 2. \n\n""" 
"""***Завдання:*** Нанести радіуси уражень на план резервуару на місцевості. Для розуміння розмірів, діаметр резервуару становить 10 м. 
Провести розрахунок надлишкового тиску вибуху при викиді стисненого газу за заданих умов. Позначити радіуси меж критичних значень ∆P (100, 50, 30, 20, 5 кПа).""")

st.markdown("""### 1. За номером залікової книжки з таблиці 1 визначити об'єм газу, який обертається в резервуарі""")
...
st.markdown("""### 2. За останньою цифрою залікової книжки з таблиці 2 визначити газ, який обертається в резервуарі""")
...
st.write("### Таблиця 2. Вид та характеристики горючого газу")
st.table(df)
