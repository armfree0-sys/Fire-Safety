...
with col_text:
    ...
    * **H1** — Повна висота від рівня рідини до входу в аварійну ємність
    * **H2** — Висота від дна резервуара до входу в аварійну ємність
    """)
...
with st.sidebar.expander("Параметри резервуара та Гідравліка", expanded=True):
...
with st.sidebar.expander("Часові обмеження"):
...
with st.sidebar.expander("Властивості рідини"):
