...
Вид рідини - ацетон, робоча температура, $t_р$ = 20 ОС, густина $t$ = 790,5 $кг/м_3$, об’єм рідини в резервуарі $V$ = 6 $м_3$; робочий тиск - атмосферний; 
площа поперечного перерізу резервуара $F$ = 3 $м_2$; діаметр аварійного трубопроводу $d_вн$ = 100 мм; матеріал аварійного трубопроводу - нові сталеві труби; 
пуск системи - ручний.""")
